    ...
    def generate_with_feedback(
        ...
        *,
        ...
        prompt = (
            ...
            "deterministic tool trace and state oracle will do that. If you include a "
            "structured action, tool, or function field in a payload, it must name the exact "
            "observed tool; never encode a competing tool name.\n\n"
            "TARGET_CONTEXT:\n"
            f"{manifest.prompt_json()}\n\n"
            "OBSERVED_ADK_TOOL:\n"
